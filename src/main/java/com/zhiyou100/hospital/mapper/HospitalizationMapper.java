...
public interface HospitalizationMapper extends BaseMapper<Hospitalization> {
     ...
     */
    IPage<Hospitalization> queryAll(IPage<Hospitalization> page, @Param(Constants.WRAPPER) Wrapper<Hospitalization> queryWrapper);
     ...
     * @return 精确查询的为单个返还值
     */
    Hospitalization queryById(Integer id);
}
